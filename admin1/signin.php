    ...
    if($f==0)
		{
			...
			$sql_login="select * from customer where cust_uname = '$username' and cust_pass='$password'";
                        ...
                        <input autocomplete="false" name="hidden" type="text" style="display:none;">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    ...
                                    <br/><br/>
                                    <h6><a href="adminlogin.php"><i class="icofont icofont-user"> Click Here to Login as Admin</i></a></h6>
                                </div>
                                </div>
