...
if(isset($_POST['add']))
{
    ...
    $av=$_POST['availability'];
				...
				$sql_insert="insert into parts(part_name,part_cost,serve_charge,availability) values('$pn','$c','$sc','$av')";
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        ...
                                        <h3 class="text-center txt-primary" style="color:royalblue" >Add Parts</h3>
                                ...
                                <div class="row m-t-30">
                                    ...
                                    <br/><br/>
                                    <h6><a href="updateparts.php"><i class="icofont icofont-database"> Update Existing </i></a></h6>
                                     </div>
